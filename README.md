...
## Hlavní funkce
* Jednoduché grafické rozhraní, které nevyžaduje žádné technické znalosti.
* Rychlé lokální zpracování (data se nikam neposílají).
* Automatické předvyplnění názvu chráněného souboru (přidá příponu `_locked`).
* Kvalitní obrázkový výstup pro zachování čitelnosti textu (200 DPI).
